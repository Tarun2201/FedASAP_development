...
class DiceLoss(_WeightedLoss):
    ...
    def forward(self, pred_binary, target_binary,wt=1):
        """
        Forward pass
...
class CombinedLoss(_Loss):
    ...
    def forward(self, input, target, weight=None):
        ...
        probs_vector = input.contiguous().view(-1, 2)
...
class Dice_with_threshold(_Loss):
    def __init__(self):
        super(Dice_with_threshold, self).__init__()
        self.dice_loss = DiceLoss()
