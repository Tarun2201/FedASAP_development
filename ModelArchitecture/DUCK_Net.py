...
from ModelArchitecture.UNet import SpatialAttention
...
class DuckNet(nn.Module):
    def __init__(self,input_channels, out_classes, starting_filters):
        ...
        ###############################################
        # Spatial at skip
        # self.spatial_t0 = SpatialAttention()
        # self.spatial_t1 = SpatialAttention()
        # self.spatial_t2 = SpatialAttention()
        # self.spatial_t3 = SpatialAttention()
        # self.spatial_t4 = SpatialAttention()
        ###############################################
    ...
    def forward(self,x):
        ...
        ##################################
        # out_t0 = self.spatial_t0(out_t0)
        # out_t1 = self.spatial_t1(out_t1)
        # out_t2 = self.spatial_t1(out_t2)
        # out_t3 = self.spatial_t1(out_t3)
        # out_t4 = self.spatial_t1(out_t4)
        #################################
